...
public class editSpecimenHTMLTest {
    ...
    public void shownFieldsMatchTheModelWithValues() throws IOException {
        ...
        assertEquals("1110101", sampleCodeField.asText());
        assertEquals("ColEvent00Y", collectionEventField.asText());
        assertEquals("Pin", basisOfRecordSelect.asText());
        assertEquals("Thessaloniki", locatedAtField.asText());
        assertEquals("Jin Kazama", ownedByField.asText());
    ...
    public void shownFieldsMatchTheModelWithEmptyFields() throws IOException {
        ...
        assertEquals(4, basisOfRecordSelect.getOptionSize());
        assertEquals("TESTCode00001", specimenCodeField.asText());
        assertEquals("", sampleCodeField.asText());
        assertEquals("", collectionEventField.asText());
        assertEquals("", basisOfRecordSelect.asText());
        assertEquals("", locatedAtField.asText());
        assertEquals("", ownedByField.asText());
        assertEquals("", mediumField.asText());
        assertEquals("Isotype", typeStatusField.getSelectedOptions().get(0).asText());
        assertEquals("", speciesField.asText());
